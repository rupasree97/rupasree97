...
<p>
<strong>Name:</strong> Rupa Sree <br/>
<strong>Tagline:</strong> Low-key addicted to building & shipping cool stuff <br/>
<strong>Mindset:</strong> Break complex → simpler → simpler → build it <br/>
<strong>Formula:</strong> (Curiosity + Consistency) × Practice = Skill <br/>
<strong>Superpower:</strong> Thinking in systems, compounding daily <br/>
<strong>Fun Fact:</strong> My brain turns most things into equations 🧮✨
</p>
...
while alive:
    ...
    compound_daily()
    repeat()
    <br/> <img src="https://media.giphy.com/media/3o7TKwxYkeW0ZvTqsU/giphy.gif" width="120" alt="sparkle sticker"/>
...
<br/> <img src="https://media.giphy.com/media/26BRuo6sLetdllPAQ/giphy.gif" width="400" alt="baddie aesthetic gif"/> <br/> </div> <!-- Footer Wave --> <img src="https://capsule-render.vercel.app/api?type=waving&color=0:c084fc,100:ffb6c1&height=120&section=footer&text=✨+keep+building,+keep+glowing+✨&fontSize=18&fontColor=ffffff&fontAlignY=65" /> ```
